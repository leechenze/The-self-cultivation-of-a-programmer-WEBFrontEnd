...
function logMethod(params) {
    return function (target, metName, parInd) {
        console.log(params);
    };
}
// 定义类装饰器;
...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.getData2 = function (uuid) {
    };
    __decorate([
        logAttr('属性')
    ...
    __decorate([
        logMethod('方法'),
        __param(0, logParams('方法参数'))
    ], HttpClient.prototype, "getData", null);
    __decorate([
        __param(0, logParams2('方法参数1'))
    ], HttpClient.prototype, "getData2", null);
